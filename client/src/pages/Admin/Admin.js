                    ...
                    <div className="row">
                            ...
                            <div className="col-lg-4 col-md-6 col-12 pb-5">
                                <Link to="/tours" exact="true">
                                    <div className="card" >
                                        <img className="card-img-top" style={{height: "15rem"}} src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcS-uSy70QL7kV5Lj_Fk5elQKXblq4vG0j2dmexGSc4OEgDAWjWN" alt="daahg" />
                                        <div className="card-body">
                            ...
                            <div className="col-lg-4 col-md-6 col-12 pb-5">
                                <Link to="/tours" exact="true">
                                    <div className="card" >
                                        <img className="card-img-top" style={{height: "15rem"}} src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcSwQAdfUjJawjL7bgvGtny0Emq6eOSiSIE-EaXKH9Tte8AOv08X" alt="Cardimagecap" />
                                        <div className="card-body">
                            ...
                            <div className="col-lg-4 col-md-6 col-12 pb-5">
                                <Link to="/tours" exact="true">
                                    <div className="card" >
                                        <img className="card-img-top" style={{height: "15rem"}} src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcRbTTM-xBrbLwzWgDBpBzrKet5tF4FiB8ONss0LIZhX9NrYFSuD" alt="Cardimagecap" />
                                        <div className="card-body">
                            ...
                            <div className="col-lg-4 col-md-6 col-12 pb-5">
                                <Link to="/tours" exact="true">
                                    <div className="card" >
                                        <img className="card-img-top" style={{height: "15rem"}} src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcSlGSpLRkztUTqu1RAGh1qP3RbKLY-n9jay8D-JJDI9ogmTA-GZ" alt="Cardimagecap" />
                                        <div className="card-body">
