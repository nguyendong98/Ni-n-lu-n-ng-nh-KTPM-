                ...
                <div className='card'>
                  ...
                  <div className='card-body'>
                    ...
                    <p className='card-text detail-text'>
                      Deluxe rooms with harmonious design, luxurious interior
                      with full modern facilities. Area of about 60-65m2 each
                      room is equipped with windows and balcony.
                    </p>
              ...
              <div className='col-12 col-lg-4'>
                <div className='card'>
                  ...
                  <div className='card-body'>
                    ...
                    <p className='card-text detail-text'>
                      Standard rooms are about 20m2 are designed in harmony with
                      luxury furniture and full of modern facilities and to the
              ...
              <div className='col-12 col-lg-4'>
                <div className='card'>
                  ...
                  <div className='card-body'>
                    ...
                    <p className='card-text detail-text'>
                      Luxury bungalow with elegant architecture and interior
                      with bright white tone combined with natural space,
                      windswept will bring you a true holiday..
                    </p>
                    <a href='/' className='btn btn-success'>
                      See more
                    </a>
