...
const Room = ({rooms}) => {
    ...
    return (
        <div className="col-lg-4 col-md-6 col-12">
            <div className="card">
                <img className="card-img-top" src={rooms.image}
                    alt="Cardimagecap" />
                <div className="card-body">
                    <h5 className="card-title">{rooms.name}</h5>
                    <h3 className="card-price">{rooms.price}$<span>/Pernight</span></h3>
                    <table>
                        <tbody>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>{rooms.services.map((val, index) => {
                                   return (index === rooms.services.length - 1) ? (val + ',.. ') : (val + ', '); 
