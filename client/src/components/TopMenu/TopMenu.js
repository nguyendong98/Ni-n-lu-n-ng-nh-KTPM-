                ...
                <div className="container">
                    <div className="collapse navbar-collapse" id="navbarNavAltMarkup text-center">
                        ...
                        <div className="navbar-nav text-center head__title-right">
                            <a className="nav-item nav-link" href="facebook.com"><i className="fa fa-facebook" aria-hidden="true"></i>.</a>
                            <a className="nav-item nav-link" href="twitter.com"><i className="fa fa-twitter" aria-hidden="true"></i>.</a>
                            <a className="nav-item nav-link" href="instagram.com"><i className="fa fa-instagram" aria-hidden="true"></i>.</a>
                            <a className="nav-item nav-link" href="youtube.com"><i className="fa fa-youtube" aria-hidden="true"></i>.</a>
                        </div>
                    </div>
                </div>
            </nav>
