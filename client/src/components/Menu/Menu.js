        ...
        return (
            <section className="main-menu">
                <div className="container">
                    ...
                    <Link to="/" exact="true"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcSlKoNFjSRZhti9Mo2F-jeMuYbwp-qROryOF_5T0H242IOloTa6" style={{width: '7rem', height: '7rem'}} alt="logo"/></Link>
    ...
    <span className="navbar-toggler-icon"></span>
                        ...
                        <div className="collapse navbar-collapse" id="navbarSupportedContent">
                            <div className="navbar-nav" style={{margin: '0 auto'}}>
                                <Link to="/" exact="true" className="nav-item nav-link " href="/"><i className="fa fa-home" aria-hidden="true" />Home</Link>
                                <a className="nav-item nav-link " href="/"><i className="fa fa-bed" aria-hidden="true" />Room</a>
